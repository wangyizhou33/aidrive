...
public:
    ...
    CircularBuffer(const CircularBuffer& other)
        : _buff{std::unique_ptr<T[]>(new value_type[other._max_size])}, _max_size{other._max_size}, _size{other._size}, _head{other._head}, _tail{other._tail}
    {
    ...
    CircularBuffer(CircularBuffer&& other) noexcept
        : _buff{std::move(other._buff)}, _max_size{other._max_size}, _size{other._size}, _head{other._head}, _tail{other._tail}
    {
